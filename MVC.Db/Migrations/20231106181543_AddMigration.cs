    ...
    public partial class AddMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("2d5e0d96-f817-4959-8ef9-9a9aac6b8552"), "Баста", 3000m, "TheBest Production", "/images/Баста.jpg", "Моя Игра", 2006 },
                    { new Guid("45ba062d-8570-459e-ba26-e388fab791f4"), "Oxxxymiron", 3150m, "Второй студийный альбом российского рэпера Oxxxymiron", "/images/Горгород.jpg", "ГОРГОРОД", 2015 },
                    { new Guid("91d11c8b-30ab-40c2-a62a-e16fe2419e26"), "GUF", 2000m, "Legendary Album", "/images/ЕЩЁ.jpg", "Ещё", 2016 },
                    { new Guid("f0f87a87-28d2-469c-8d50-24d228a49942"), "Скриптонит", 1850m, "Дебютный альбом", "/images/Скриптонит.jpg", "Дом с нормальными явлениями", 2015 }
                });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Products",
                keyColumn: "Id",
                keyValue: new Guid("2d5e0d96-f817-4959-8ef9-9a9aac6b8552"));

            migrationBuilder.DeleteData(
                table: "Products",
                keyColumn: "Id",
                keyValue: new Guid("45ba062d-8570-459e-ba26-e388fab791f4"));

            migrationBuilder.DeleteData(
                table: "Products",
                keyColumn: "Id",
                keyValue: new Guid("91d11c8b-30ab-40c2-a62a-e16fe2419e26"));

            migrationBuilder.DeleteData(
                table: "Products",
                keyColumn: "Id",
                keyValue: new Guid("f0f87a87-28d2-469c-8d50-24d228a49942"));
